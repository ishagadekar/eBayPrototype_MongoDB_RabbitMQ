...
var ebayHome = require('./services/ebayhome');
...
cnn.on('ready', function(){
	...
	cnn.queue('login_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			ebayHome.handle_login_request(message, function(err,res){
...
cnn.on('ready', function(){
	...
	cnn.queue('register_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			ebayHome.handle_register_request(message, function(err,res){
...
cnn.on('ready', function(){
	console.log("listening on userdata_queue");

	cnn.queue('userdata_queue', function(q){
		q.subscribe(function(message, headers, deliveryInfo, m){
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
